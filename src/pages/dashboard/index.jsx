...
const DashboardPage = () => {
    return (
        <>
           <DashBoardNavbar/>
           <div className="flex flex-col lg:flex-row bg-gray-100 min-h-screen gap-6 pt-6 px-2 md:px-6">
             {/* Sidebar */}
             <div className="w-full lg:max-w-xs flex flex-col gap-5 mb-4 lg:mb-0">
               <ProfileCard />
             </div>
             ...
             <div className="flex-1 flex flex-col lg:flex-row gap-5">
               ...
               {/* Right sidebar */}
               <div className="w-full lg:max-w-xs flex flex-col gap-5 mt-4 lg:mt-0">
                 <StatsCards />
                 <RightSidebarSearch />
                 <JobSuggestions />
                 <RecentJobSearch />
